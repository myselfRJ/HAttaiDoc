    ...
    <ScrollView>
      <View style={styles.main}>
       ...
       {symptom.length >0 && (
        ...
        {refer_doctor?.[0]?.doctor_name && (
          <View>
            <Text style={styles.head}>
              {Language[language]['refer_doctor']} :
            </Text>
            <View style={styles.refer}>
              {refer_doctor?.map((val, ind) => (
                <View key={ind}>
                  <Text style={styles.values}>
                    {Language[language]['name']} :{' '}
                    <Text style={styles.values}>{val.doctor_name}</Text>
                  </Text>
                  <Text style={styles.values}>
                    {Language[language]['specialist']} :{' '}
                    <Text style={styles.values}>{val.speciality}</Text>
                  </Text>
                  <Text style={styles.values}>
                    {Language[language]['ph']} :{' '}
                    <Text style={styles.values}>{val.phone}</Text>
                  </Text>
                </View>
              ))}
            </View>
