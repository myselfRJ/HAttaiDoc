export const CONSTANT={
    ...
    ConsultationList:[
        ...
        {label: 'Commorbities', icon: 'chevron-right', navigate: 'commorbities'},
        {label: 'Past History', icon: 'chevron-right', navigate: 'pasthistory'},
        ...
        {label: 'Test Prescribed', icon: 'chevron-right', navigate: 'labreport'},
        {
