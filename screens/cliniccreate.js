...
import { CUSTOMFONTFAMILY, CUSTOMFONTSIZE,CUSTOMCOLOR } from "../settings/styles";
    ...
    return (
        ...
        <View style={styles.leftchild}>
            ...
            <View  style={styles.alignchild}>
                ...
                <HButton icon='plus'label='Schedule' onPress={()=>navigation.navigate('createslot')}/>
                </View>
            <InputText label='Fees' placeholder='Clinic Fees'/>
            <InputText label='Speciality' placeholder='Speciliality'/>
            <HButton label='login' onPress={()=>navigation.navigate('usercreate')}/>
        ...
        <PlusButton icon='forward'style={{position:'absolute',right:64,bottom:96}} onPress={()=>navigation.navigate('usercreate')}/>
        </View>
    </Keyboardhidecontainer>
    )
}
